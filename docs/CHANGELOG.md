...
- **L3 — Database trigger** (migration 0.35.0, per-dialect SQL for sqlite3/postgres/mysql): rejects UPDATE/DELETE against protected rows. Catches raw SQL, SQL injection, rogue migrations
