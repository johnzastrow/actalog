...
- [ ] `[HIGH]` **Admin: edit full user details on Profile tab (v1.3.1)** — extend Profile tab with admin-set password (separate from existing force-password-reset), role change, account-disabled toggle. Brainstorm together with create-user since both touch admin password handling
