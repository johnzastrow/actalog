...
./docker/scripts/push.sh <version> # Push version tag (e.g., 1.2.0-beta)
...
docker tag ghcr.io/johnzastrow/actalog:dev ghcr.io/johnzastrow/actalog:latest
docker tag ghcr.io/johnzastrow/actalog:dev ghcr.io/johnzastrow/actalog:1.2.0-beta  # Use current version
./docker/scripts/push.sh dev
./docker/scripts/push.sh latest
./docker/scripts/push.sh 1.2.0-beta  # Use current version
