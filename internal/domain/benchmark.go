...
type BenchmarkOptions struct {
	...
	RecordCount       int  // Number of records to generate (default: 1000, max: 500000)
}

// DefaultRecordCount is the default number of records for benchmarking
const DefaultRecordCount = 1000

// MaxRecordCount is the maximum allowed records for benchmarking
const MaxRecordCount = 500000
