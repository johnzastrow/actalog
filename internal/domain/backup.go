...
type BackupData struct {
	...
	UserOrganizations         []map[string]interface{} `json:"user_organizations"`
	UserSubscriptions         []map[string]interface{} `json:"user_subscriptions"`
	OrganizationSubscriptions []map[string]interface{} `json:"organization_subscriptions"`
	Notifications             []map[string]interface{} `json:"notifications"`
	NotificationLikes         []map[string]interface{} `json:"notification_likes"`
}
