...
func (r *MovementRepository) GetByID(id int64) (*domain.Movement, error) {
	query := rebindQuery(`SELECT id, name, description, type, is_standard, created_by, created_at, updated_at FROM movements WHERE id = ?`)
...
func (r *MovementRepository) GetByName(name string) (*domain.Movement, error) {
	query := rebindQuery(`SELECT id, name, description, type, is_standard, created_by, created_at, updated_at FROM movements WHERE name = ?`)
...
func (r *MovementRepository) ListAll() ([]*domain.Movement, error) {
	query := rebindQuery(`SELECT id, name, description, type, is_standard, created_by, created_at, updated_at FROM movements ORDER BY name`)
...
func (r *MovementRepository) ListByUser(userID int64) ([]*domain.Movement, error) {
	query := rebindQuery(`SELECT id, name, description, type, is_standard, created_by, created_at, updated_at FROM movements WHERE created_by = ? ORDER BY name`)
...
func (r *MovementRepository) ListAllUserCreatedWithUserInfo() ([]*domain.MovementWithCreator, error) {
	query := rebindQuery(`SELECT m.id, m.name, m.description, m.type, m.is_standard, m.created_by, m.created_at, m.updated_at,
