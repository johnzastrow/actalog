// Package protectedusers provides the boot-time invariant checker and admin CLI
// helpers for enforcing the protected-user defense layers. Placing these in an
// importable package (rather than package main) lets both cmd/actalog and the
// integration test suite call them directly.
